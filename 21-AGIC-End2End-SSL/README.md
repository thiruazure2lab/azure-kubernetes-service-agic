...
```yaml
  annotations:
    ...
    # Backend Annotations
    appgw.ingress.kubernetes.io/backend-hostname: "backend.thiruaws.com" # Optional
...
openssl req -new -key frontend-ingress.key -out frontend-ingress.csr -subj "/CN=frontend.thiruaws.com"
...
spec:
  ...
  - secretName: frontend-tls-secret
    hosts:
    - frontend.thiruaws.com
  rules:
    - host: frontend.thiruaws.com
      http:
        paths:
          - path: /
            pathType: Prefix
...
5. Override with new host name: backend.thiruaws.com
6. Custom probe
...
2.5 Host names: frontend.thiruaws.com
...
```t
# Access Application
http://frontend.thiruaws.com
Observation:
1. should redirect to HTTPS url
2. Review SSL Certificate whose CN should frontend.thiruaws.com which we used during creation of frontend SSL Certificate
...
tcpdump -l
Access URL in browser: http://frontend.thiruaws.com
exit
```
