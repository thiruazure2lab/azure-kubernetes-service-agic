...
spec:
  ...
  tls:
  - secretName: sapp1-thiruaws-secret 
    hosts:
    - sapp1.thiruaws.com    
  - secretName: sapp2-thiruaws-secret                     
    hosts:
    - sapp2.thiruaws.com  
  rules:
    - host: sapp1.thiruaws.com
      http:
        paths:
          - path: /
            pathType: Prefix
...
kubectl get secret sapp1-thiruaws-secret -o yaml
kubectl get secret sapp2-thiruaws-secret -o yaml
Observation:
...
sapp1-thiruaws-secret   True    sapp1-thiruaws-secret   2m48s
sapp2-thiruaws-secret   True    sapp2-thiruaws-secret   2m48s
...
2. We should see two port 443 listeners created to serve content for App1 and App2 with hostnames as sapp1.thiruaws.com, sapp2.thiruaws.com
...
1.1 cert-default-sapp1-thiruaws-secret
1.2 cert-default-sapp2-thiruaws-secret
...
http://sapp1.thiruaws.com/app1/index.html
http://sapp2.thiruaws.com/app2/index.html
Observation:
1. Should redirect to HTTPS url
2. We have added AGIC ssl-redirect annotation in Ingress Manifest

# Application HTTPS URLs
https://sapp1.thiruaws.com/app1/index.html
https://sapp2.thiruaws.com/app2/index.html
Observation
